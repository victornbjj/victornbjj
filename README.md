...
Olá! Sou **Victor Nascimento**, estudante e entusiasta de tecnologia com foco em **desenvolvimento web, automação e fundamentos de segurança cibernética**.
Busco aplicar o conhecimento de forma prática através de projetos reais, estudos contínuos e desafios técnicos.

Além da tecnologia, pratico **Jiu-Jitsu**, esporte que fortalece minha disciplina, constância e mentalidade de evolução — valores que levo diretamente para a minha carreira na área de TI.
...
* Python avançado (Flask / Django)
* Desenvolvimento Web (HTML, CSS, JavaScript)
* Redes e fundamentos de Segurança da Informação
...
* 📧 Email: [victorifpb78@gmail.com](mailto:victorifpb78@gmail.com)
...
Se quiser colaborar em algum projeto, tirar dúvidas ou apenas conversar sobre tecnologia, fique à vontade para entrar em contato.
